package br.com.dbc.produtor.service;
    ...
    public void enviarMensagemKafka(String mensagem) {
        ...
        future.addCallback(new ListenableFutureCallback<>() {
            ...
            public void onSuccess(SendResult<String, String> result) {
                log.info("Log enviado para o kafka com o seguinte texto: {} ", mensagem);
            }

            @Override
            public void onFailure(Throwable ex) {
                log.error("Erro ao enviar a seguinte mensagem para o Kafka: {}", mensagem, ex);
            }
        });
    }
}
