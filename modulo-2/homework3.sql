...
SELECT P.*,
	   ...
	   EP.*
FROM					PESSOA P			
	RIGHT OUTER JOIN 	PESSOA_X_PESSOA_ENDERECO PXE ON (P.ID_PESSOA      = PXE.ID_PESSOA)
	RIGHT OUTER JOIN 	ENDERECO_PESSOA EP           ON (PXE.ID_ENDERECO  = EP.ID_ENDERECO)
...
SELECT P.*,
	   ...
	   EP.*
FROM					PESSOA P			
	FULL OUTER JOIN 	PESSOA_X_PESSOA_ENDERECO PXE ON (P.ID_PESSOA      = PXE.ID_PESSOA)
	FULL OUTER JOIN 	ENDERECO_PESSOA EP           ON (PXE.ID_ENDERECO  = EP.ID_ENDERECO)
...
SELECT ID_PESSOA, 
	   NOME 
FROM 			  PESSOA P
	WHERE EXISTS (SELECT ID_PESSOA FROM PESSOA_X_PESSOA_ENDERECO PXE WHERE P.ID_PESSOA = PXE.ID_PESSOA)
...
FROM 					ENDERECO_PESSOA 		 EP
	LEFT OUTER JOIN 	PESSOA_X_PESSOA_ENDERECO PXE ON (EP.ID_ENDERECO      = PXE.ID_ENDERECO)
	LEFT OUTER JOIN 	PESSOA 					 P   ON (PXE.ID_PESSOA       = P.ID_PESSOA)	
